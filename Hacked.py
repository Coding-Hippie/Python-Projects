...
app = {# REQUIRED dict, must be named 'app'
    'name' : 'Open AI', # Application name
    'macros' : [# List of button macros...
        # COLOR    LABEL    KEY SEQUENCE
        # 1st row ----------
        (0x002400, 'Win', ["""D00dle-420""", Keycode.ENTER]), # Text + Enter
        (0x000090, 'TskMgr', [Keycode.CONTROL, Keycode.SHIFT, Keycode.ESCAPE]), # Task Manager
        (0x002400, 'Excel', ["""resked2019""", Keycode.ENTER]),
        # 2nd row ----------
        (0x069690, 'PrtSc', [Keycode.PRINT_SCREEN]),
        (0x000090, 'GUI', [Keycode.GUI, 'r']), # Opens windows run GUI console
        (0x069420, 'Spotify', [Keycode.CONTROL, Keycode.KEYPAD_ONE]), # Runs programmed exe shortcut
        # 3rd row ----------
